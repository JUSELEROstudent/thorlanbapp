...
const connectionsreamall = new signalR.HubConnectionBuilder().withUrl('https://192.168.10.119:4040/UpdateStatus', {
...
export default defineComponent({
  ...
  data () {
    return {
      testdata: true,
      Urlcurrentimg: 'https://192.168.10.119:4040/SouerceStaticFiles/HxVmosaic.jpg',
      status2: ''
    }
  },
  methods: {
