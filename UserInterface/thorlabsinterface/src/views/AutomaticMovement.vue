...
export default {
  ...
  data () {
    return {
      ...
      status2: 'error',
      alerttype: 'error',
      carousel: ['https://192.168.10.116:4040/SouerceStaticFiles/HxVmosaic.jpg'],
  ...
  methods: {
    ...
    startmapping: function () {
      ...
      fetch('https://192.168.10.116:4040/automotion/mapping', requestOptions)
    ...
    startcalibrate: function () {
      ...
      fetch('https://192.168.10.116:4040/automotion/calibrate', requestOptions)
        .then(response => response.text())
