<template>
    ...
    <div class="flex flex-row min-h-72 w-full bg-gray rounded">
        <div class="flex flex-row bg-lightgray w-full m-2 rounded ">
            ...
            <div class="w-full align-middle h-full">
                <div class="flex flex-col  m-3">
                <label class="m-auto ">
...
// function onClickKeyboardComandsA(){
//     addEventListener("keydown",(event)=>
//     {
//         if (event.key == "a")
//         {
//             console.log("preciono la letra A")
//         }
//         console.log("preciono la letra " + event)
//     })
// }

function OnEventListenerExecute(evento:any) {
    if(modeselect.value[0] == "keyboard"){
        //is necesary complete all the features for this function 
        if(evento != null )
        {

        }
        console.log(evento.key)
        console.log("ES keyboard")
