<template>
    ...
    <div class="bg-greenuis w-16 h-screen  shadow-2xl flex flex-col content-between  gap-4 sticky top-0 self-start" :class="{ 'w-48' : statusbar}">
        ...
        <div class="flex justify-center align-bottom transition-transform duration-200 hover:scale-110" title="Iniciar sesión"><NuxtLink href="/login"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 16 16"><path fill="white" d="M6.75 1.5a.75.75 0 0 0 0 1.5h4.75A1.5 1.5 0 0 1 13 4.5v7a1.5 1.5 0 0 1-1.5 1.5H6.75a.75.75 0 0 0 0 1.5h4.75a3 3 0 0 0 3-3v-7a3 3 0 0 0-3-3zm3.03 5.97l-2.5-2.5a.75.75 0 0 0-1.06 1.06l1.22 1.22H1.75a.75.75 0 0 0 0 1.5h5.69L6.22 9.97a.75.75 0 1 0 1.06 1.06l2.5-2.5a.75.75 0 0 0 0-1.06"/></svg></NuxtLink></div>   
        </div>
    </div>
